class Startup < ActiveRecord::Base
  ...
  has_attached_file :startup_logo, :whiny => false, :styles => { :icon => ["64>x64"], :small => ["128x128>"], :medium => ["300x300>"], :large => ["1224x1584>"] }, #:styles      => {:icon => "50x50#", :thumb=> "100x100#", :small  => "190x190#", :large => "500x500>" },
